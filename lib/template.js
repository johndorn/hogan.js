...
(function (Hogan, useArrayBuffer) {
  ...
  function hoganEscape(str) {
    // Considering replacing this method with a call to he.encode()
    // See https://github.com/mathiasbynens/he#heencodetext-options
    // hogan chokes on astral unicode, he.encode() does not
